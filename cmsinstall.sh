...
herccontrol "/tape load * h h" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
herccontrol "/tape load * maclib h" -w "^Ready;"
...
herccontrol "/tape load * memo z" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
...
herccontrol "/tape load * maclib z" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
herccontrol "/tape load * txtlib z" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
herccontrol "/tape load * text z" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
herccontrol "/tape load sysprof exec z" -w "^Ready;"
herccontrol "/tape rew" -w "^Ready;"
herccontrol "/release z"  -w "^Ready;"
