...
char *strerror(int errnum) {
    switch (errnum) {
        case 0:
            return ("No error code has been recorded.");
        case EPERM:
        ...
        case EGREGIOUS:
            return ("You really blew it this time.");
        case EIEIO:
            return ("Computer bought the farm.");
        case EGRATUITOUS:
            return ("Gratuitous error.");
        case EBADMSG:
            return ("Bad message.");
        case EIDRM:
        ...
        case ESTACKOVERFLOW:
            return ("Auxiliary stack overflow.");
        case EMALLOC:
            return ("DLMalloc aborted.");
        default:
