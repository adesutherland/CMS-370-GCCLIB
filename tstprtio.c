...
static void fopen_t() {
  FILE* f;
  SUB_STRT("fopen()");
  ASSERTNULL("fopen(PRINTER,r)", f=fopen("PRINTER","r"), f, if (f) fclose(f));
  ASSERTNOTNULL("fopen(PRINTER,w)", f=fopen("PRINTER","w"), f, if (f) fclose(f));
  ASSERTNOTNULL("fopen(PRINTER,a)", f=fopen("PRINTER","a"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,rb)", f=fopen("PRINTER","rb"), f, if (f) fclose(f));
  ASSERTNOTNULL("fopen(PRINTER,wb)", f=fopen("PRINTER","wb"), f, if (f) fclose(f));
  ASSERTNOTNULL("fopen(PRINTER,ab)", f=fopen("PRINTER","ab"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,r+)", f=fopen("PRINTER","r+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,w+)", f=fopen("PRINTER","w+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,a+)", f=fopen("PRINTER","a+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,rb+)", f=fopen("PRINTER","rb+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,wb+)", f=fopen("PRINTER","wb+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,ab+)", f=fopen("PRINTER","ab+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,r+b)", f=fopen("PRINTER","r+b"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,w+b)", f=fopen("PRINTER","w+b"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,a+b)", f=fopen("PRINTER","a+b"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,x)", f=fopen("PRINTER","x"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,+)", f=fopen("PRINTER","+"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,b)", f=fopen("PRINTER","b"), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,)", f=fopen("PRINTER",""), f, if (f) fclose(f));
  ASSERTNULL("fopen(PRINTER,r+bx)", f=fopen("PRINTER","r+bx"), f, if (f) fclose(f));
}
...
static void fgetc_t() {
  ...
  SUB_STRT("fgetc() - text");
  ASSERTNULL("fopen(PRINTER,r)", test=fopen("PRINTER","r"), test, if (test) fclose(test));
  ASSERTNOTNULLP("fopen(PRINTER,w)", test=fopen("PRINTER","w"), test, );
  ASSERTEOF("fgetc()", , fgetc(test), );
  ASSERTNOTZERO("ferror()", , ferror(test), );
  ASSERTZEROP("fclose()", , fclose(test), );
  ...
  ASSERTNULL("fopen(PRINTER,rb)", test=fopen("PRINTER","rb"), test, if (test) fclose(test));
